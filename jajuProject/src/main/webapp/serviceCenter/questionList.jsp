		...
		<div class="page_section">
			<div id="questionTotal" style="margin-bottom: 50px;">
				...
				<div class="xans-element- xans-myshop xans-myshop-couponserial">
					...
					<div style="width: 800px;" id="tableDiv">
						...
						<tr>
							...
							<td><br>
								<div class="search" style="float: right;">
									...
									</select> <a id="searchBtn" style="cursor: pointer;"> <img
										src="/jaju/jajuImage/search.png">
									</a> <input type="text" id="keyword" name="keyword"
										value="${keyword}" style="font-size: 14px;">
								</div></td>
						</tr>
					</tbody>
				</table>
