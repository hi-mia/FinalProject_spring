...
<div id="total">
	<div class="page_section section_qna" style="min-height: 550px;">
		...
		<div id="table">
			<table class="xans-board-listheader" style="width: 800px; table-layout: fixed;">
				<tbody>
					<tr class="input_txt">
						<th width="65px;">번호</th>
						<th width="156px;">카테고리 </th>
						<th width="300px;">제목</th>
						<th width="93px;">작성자</th>
						<th width="93px;">작성일</th>
						<th width="93px;">처리상태</th>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<table class="reportListTable" style="width: 800px; table-layout: fixed; border-top: 1px solid #e6e6e6; border-bottom: 1px solid #e6e6e6;"></table>
