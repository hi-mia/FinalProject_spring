...
<h2 class="tit" style="font-size: 31px; color: #333; margin-top:50px;">공지사항 수정</h2>
</div>

<div class="xans-board-write">
<form name="noticeWriteForm" id="noticeWriteForm" method="post"  enctype="multipart/form-data" style="height: 100%;">
<input type="hidden" id="notice_seq" name="notice_seq" value="${param.notice_seq}">
	...
	<tbody>
		<tr>
			<td align="right" style="padding-top:5px; border:none;" id="avoidDbl">
				<input type="button"class="bhs_button yb" id="noticeModifyBtn" value="수정" style="float:none;">
			</td>
		</tr>
	</tbody>
</table>
...
<script src="/jaju/manager_js/managerNoticeModify.js"></script>
