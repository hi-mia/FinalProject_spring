...
<ul class="list_lnb">
	<li class="lnb_admin1" >
		...
		<ul>
			<li id="founder_standard_v2" style="text-align: left;"><a href="/jaju/manager/managerMainChart" class="link_lnb">통계</a></li>
		</ul>
	</li>
	<li class="lnb_admin2">
	...
	<li class="lnb_admin3">
		...
		<ul>
			<li id="managerServiceNotice" style="text-align: left;"><a href="/jaju/manager/managerNoticeList" class="link_lnb">공지사항 관리</a></li>
			...
			<li id="managerServiceReport" style="text-align: left;"><a href="/jaju/manager/managerReportList" class="link_lnb">신고게시판 관리</a></li>
		</ul>
	</li>
</ul>
</div>
